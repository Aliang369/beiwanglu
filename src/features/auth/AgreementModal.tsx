...
const agreementContent = {
  ...
  privacy: {
    ...
    sections: [
      {
        title: '1. 我们收集哪些信息',
        body: '在当前原型中，可能涉及您主动输入的用户名、邮箱、密码字段、注册勾选状态，以及应用内创建的笔记标题、正文、标签和文件夹等内容。',
      },
      {
      ...
      {
        title: '4. 账号信息和登录信息',
        body: '注册和登录界面目前用于演示认证流程。若未来接入真实账号系统，可能会处理邮箱、用户名、登录凭证、验证码状态和安全审计信息。',
      },
      {
        title: '5. 数据使用目的',
      ...
      {
        title: '8. 第三方服务说明',
        body: '当前原型不包含真实短信、邮件、支付或第三方登录服务。未来如接入第三方服务，应说明其用途、共享的数据类型和对应的第三方隐私规则。',
      },
      {
        title: '9. 政策更新',
