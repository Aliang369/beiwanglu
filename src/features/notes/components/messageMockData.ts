...
export const messageItems: MessageItem[] = [
  ...
  },
  {
    ...
    title: '新设备登录提醒',
    summary: '您的账户刚刚在 macOS 设备上（IP: 192.168.1.xxx，北京）进行了登录。如果这不是您的操作，请立即更改密码。',
    content: [
      '我们检测到您的账户刚刚在一台新的 macOS 设备上完成登录。',
      '登录地点显示为北京，设备 IP 为 192.168.1.xxx。如果这是您本人的操作，可以忽略此提醒；如果不是，请尽快修改密码并检查账户安全设置。',
    ],
    time: '2 小时前',
    type: 'reminder',
    category: 'security',
